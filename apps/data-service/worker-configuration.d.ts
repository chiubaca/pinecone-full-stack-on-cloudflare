/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv` (hash: 801fd4ef41cf308849c1e5dd1fcf1998)
// Runtime types generated with workerd@1.20250709.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CACHE: KVNamespace;
		EVALUATION_SCHEDULER: DurableObjectNamespace<import("./src/index").EvaluationScheduler>;
		LINK_CLICK_TRACKER_DO: DurableObjectNamespace<import("./src/index").LinkClickTracker>;
		BUCKET: R2Bucket;
		DB: D1Database;
		QUEUE: Queue;
		VIRTUAL_BROWSER: Fetcher;
		AI: Ai;
		DESTINATION_EVALUATION_WORKFLOW: Workflow;
	}
}
